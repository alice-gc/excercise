...
<div class="d-flex flex-column shadow-lg" style="padding:2%;">
  <div class="container">
    <div class="row">
      <div class="col text-center">
        <h1>Privacy Policy for My Hybrid Calisthenic Routine</h1>
      </div>
    </div>
    <hr style="border: 5px solid green; padding:-5%;">
...
<div class="translations-content-container">
  <div class="container">
    <div class="tab-content translations-content-item en visible" id="en">
      ...
      <ul>
        ...
        <li>
          <p><strong>Application</strong> means the software program provided by the Company downloaded by You on
            any electronic device, named My Hybrid Calisthenic Routine</p>
        </li>
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
            or &quot;Our&quot; in this Agreement) refers to My Hybrid Calisthenic Routine.</p>
        </li>
        <li>
      ...
      <ul>
<a href="https://www.freeprivacypolicy.com" target="_blank">https://www.freeprivacypolicy.com</a>
      </ul>
    </div>
  </div>
</div>
...
<div class="footer">
  <div class="container">
    <p>Generated using <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank">Free
